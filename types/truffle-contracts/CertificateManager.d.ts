...
export interface CertificateManagerContract
  extends Truffle.Contract<CertificateManagerInstance> {
  "new"(
    _application: string,
    meta?: Truffle.TransactionDetails
  ): Promise<CertificateManagerInstance>;
}

type AllEvents = never;

export interface CertificateManagerInstance extends Truffle.ContractInstance {
